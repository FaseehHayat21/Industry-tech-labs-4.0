  ...
  return (
    <section className="founders-section">
      ...
      <div className="content">
        ...
        <p>Climate tech is at the forefront of addressing the world’s most urgent environmental challenges, from reducing greenhouse gas emissions to enhancing resilience against climate impacts. This sector encompasses a diverse range of innovations, including clean energy solutions, sustainable agriculture practices, carbon capture technologies, and resource-efficient manufacturing. Companies and startups within the climate tech field are pioneering advancements that are essential for achieving a low-carbon, sustainable future.</p>
        <p>
