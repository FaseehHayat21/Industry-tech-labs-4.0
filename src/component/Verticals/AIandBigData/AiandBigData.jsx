  ...
  return (
    <section className="founders-section">
      ...
      <div className="content">
        ...
        <p><strong>AI and Big Data</strong> are reshaping industries by enabling businesses to make data-driven decisions, optimize operations, and create personalized experiences. From predictive analytics to automation, AI and Big Data technologies empower organizations to extract valuable insights from vast amounts of data, unlocking new opportunities for innovation and efficiency.</p>
        <p>
