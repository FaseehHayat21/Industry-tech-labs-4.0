  ...
  return (
    <section className="founders-section">
      ...
      <div className="content">
       ...
       <p><strong>Infinity Tech Labs</strong> fosters collaboration between startups and enterprises to drive success. We provide tailored solutions to meet partners' goals, encouraging innovation and connections between corporate innovators, entrepreneurs, and communities to promote business growth and economic transformation.</p>
