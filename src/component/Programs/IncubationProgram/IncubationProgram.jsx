  ...
  return (
    <section className="founders-section">
      ...
      <div className="content">
        ...
        <p>
        The program also offers the opportunity to build valuable partnerships, strengthen their operational strategies, and enhance their market positioning. With a focus on long-term growth, the Incubation Program equips its members with the tools needed to navigate challenges, optimize their offerings, and successfully launch their businesses.
        </p>
        <p>
